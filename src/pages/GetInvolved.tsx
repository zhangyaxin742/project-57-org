  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">
            Stay <span className="bg-sunset-gradient bg-clip-text text-transparent">Connected</span>
          </h2>
          
          <Card className="bg-gray-900/50 border-white/10 max-w-2xl mx-auto">
            <CardHeader>
              <Mail className="h-12 w-12 text-sunset-purple mx-auto mb-4" />
              <CardTitle className="text-white">Join Our Newsletter</CardTitle>
              <CardDescription className="text-gray-300">
                Get updates on new programs, funding opportunities, and ways to get involved
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex gap-4">
                <input 
                  ...
                  className="flex-1 px-4 py-2 bg-black border border-white/20 rounded-lg text-white placeholder-gray-400 focus:border-sunset-pink focus:outline-none"
                />
                <Button 
                  className="bg-sunset-gradient hover:opacity-90 text-black font-semibold px-6"
                >
                  Subscribe
                </Button>
              </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8">
            Questions? <span className="bg-sunset-gradient bg-clip-text text-transparent">Let's Talk</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-black/50 border-white/10">
              ...
              <CardContent>
                <p className="text-sunset-pink">hello@project57.org</p>
              </CardContent>
            </Card>

            <Card className="bg-black/50 border-white/10">
              <CardHeader>
                <CardTitle className="text-white">Volunteer Questions</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sunset-pink">volunteer@project57.org</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black/50 border-white/10">
              ...
              <CardContent>
                <p className="text-sunset-pink">partnerships@project57.org</p>
              </CardContent>
            </Card>
          </div>
        </div>
