...
const OurCards = () => {
  ...
  },
  {
    ...
    title: (
      <>
      An Act Relative to the Strengthening <br /> 
        of Financial Literacy Throughout the Commonwealth </>
      ),
    number: "H.627",
    summary:
...
{completed.length > 0 && (
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden overflow-y-scroll no-scrollbar">
      <Navigation />
