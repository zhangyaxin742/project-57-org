            ...
            {navItems.map(item => (
              <div key={item.name} className="relative">
                {item.dropdown ? (
                  ...
                  <RouterLink
                    to={item.path}
                    className={`text-white hover:text-sunset-pink transition-colors ${location.pathname === item.path ? 'text-sunset-pink' : ''
                      }`}
                  >
                    {item.name}
                  </RouterLink>
              ...
              {navItems.map(item => (
                <div key={item.name} className="relative">
                  {item.dropdown ? (
                    ...
                    <RouterLink
                      to={item.path}
                      className={`block px-3 py-2 text-white hover:text-sunset-pink transition-colors ${location.pathname === item.path ? 'text-sunset-pink' : ''
                        }`}
                      onClick={() => setIsOpen(false)}
                    >
                      {item.name}
